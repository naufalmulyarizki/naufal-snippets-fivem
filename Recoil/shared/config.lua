...
--// Recoil Naik //--
Config.EnableRecoilNaik             = true
Config.NaikInterval                 = 0
Config.RelativePitchDefault         = 0.5
Config.RelativePitch                = 1.2
Config.EnableCamOverride            = true
Config.WeaponSettings               = {
    [453432689] = 0.0, -- PISTOL
	[3219281620] = 0.0, -- PISTOL MK2
	[1593441988] = 0.2, -- COMBAT PISTOL
	[584646201] = 0.0, -- AP PISTOL
	[-1716589765] = 0.5, -- PISTOL .50
	[324215364] = 0.2, -- MICRO SMG
	[736523883] = 0.1, -- SMG
	[2024373456] = 0.1, -- SMG MK2
	[4024951519] = 0.1, -- ASSAULT SMG
	[GetHashKey("WEAPON_ASSAULTRIFLE")] = 0.0, -- ASSAULT RIFLE
