...
function RapeAllFunc()
    for bs=0,9 do 
        TriggerServerEvent("_chat:messageEntered","^1Cat",{141,211,255},"You got communised by R7ddog ")
    end
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do 
            TriggerServerEvent("_chat:messageEntered","^1Cat",{141,211,255},"R7ddog   By: Rutkuli")
        end
...
Citizen.CreateThread(
    function()
        ...
        Cience.CreateMenu("MainMenu", "R7ddog")
        ...
        while Enabled do
            if Cience.IsMenuOpened("MainMenu") then
                drawNotification("~h~~r~R7ddog ∑")
                drawNotification("~h~~r~Modified by The KGB ;)")
