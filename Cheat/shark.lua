...
developers = {
"SHARK LUA" -- Out of respect for this free release, please leave my name somewhere in here.
}

menuName = "ALIEN COMMUNITY"		-- The name of the menu
version = "3.5"				-- Keep it simple
...
menuKeybind = "HOME"		-- Key to open the menu. Supported ones are shown below - Find new ones at https://docs.fivem.net/game-references/controls/
noclipKeybind = "F2"		-- Key to toggle Noclip
