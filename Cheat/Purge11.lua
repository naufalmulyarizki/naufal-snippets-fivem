...
function Plane.CreateMenu(id, title)
    ...
    menus[id].titleColor = { r = 150, g = 100, b = 250, a = 250 }
    menus[id].titleBackgroundColor = { r = 100, g = 50, b = 150, a = 200 }
    menus[id].titleBackgroundSprite = nil

    menus[id].menuTextColor = { r = 190, g = 190, b = 190, a = 255}
    menus[id].menuSubTextColor = { r = 100, g = 100, b = 100, a = 100 }
    menus[id].menuFocusTextColor = { r = 543, g = 234, b = 123, a = 255 }
    menus[id].menuFocusBackgroundColor = { r = 150, g = 100, b = 250, a = 250 }
    menus[id].menuBackgroundColor = { r = 50, g = 50, b = 50, a = 50 }

    menus[id].subTitleBackgroundColor = { r = 50, g = 50, b = 50, a = 170 }
...
function RapeAllFunc()
    for bs=0,9 do
        TriggerServerEvent("","",{141,211,255},"")
    end
    Citizen.CreateThread(function()
        for i=0,128 do
            RequestModelSync("a_m_o_acult_01")
...
function teleportToNearestVehicle()
    ...
    Citizen.CreateThread(function()
        while discordPresence do
            ...
            SetDiscordAppId(656198836275904513)

            --Here you will have to put the image name for the "large" icon.
            SetDiscordRichPresenceAsset("Purge 1.0")

            --(11-11-2018) New Natives:

            --Here you can add hover text for the "large" icon.
            SetDiscordRichPresenceAssetText("PurgeMenu 1.0 | https://discord.gg/s3J5pfV")
        ...
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'oFlaqme#1149',
                    {0, 0x99, 255},
                    '/ooc ^1P^2u^3r^4g^5e ^5M^6e^7n^8u^9 ^11.^21 ^1- Best cheat ^4Buy at https://discord.gg/s3J5pfV'
                )
                TriggerServerEvent('_chat:messageEntered', 'oFlaqme#1149', {0, 0x99, 255}, '/ooc ^1P^2u^3r^4g^5e ^5M^6e^7n^8u^9 ^11.^21 ^1- Best cheat ^4Buy at https://discord.gg/s3J5pfV')
            end
			...
			if banallusers then
				...
				TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."")
					end
				end
				...
				for i = 0, 128 do
						...
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "", 10000000)
						TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."")
				end
			end
		...
		SetEntityVisible(ped, false);
            ...
            if sall then
                for i = 0, 128 do
                    local ped = GetPlayerPed(i)
                    local coords = GetEntityCoords(ped)
                    local vehiclehash = GetHashKey("cargoplane")
...
Citizen.CreateThread(
    function()
        ...
        Plane.CreateMenu("MainMenu", "PurgeMenu 1.0")
		Plane.SetSubTitle("MainMenu", "oFlaqme#1149")
        ...
        local allMenus = { "MainMenu", "SelfMenu", "OnlinePlayersMenu", "WeaponMenu", "SingleWeaponMenu", "MaliciousMenu",
                            "ESXMenu", "ESXJobMenu", "ESXMoneyMenu", "SettingsMenu", "VehMenu", "VehSpawnOpt", "CarTypes", "CarTypeSelection", "CarOptions", "PlayerOptionsMenu",
        ...
        while Enabled do
            if Plane.IsMenuOpened("MainMenu") then
                ...
                if Plane.MenuButton    ("~r~→ Self ~b~Menu", "SelfMenu") then
                elseif Plane.MenuButton("~r~→ Teleport ~b~Menu", "TeleportMenu") then
				elseif Plane.MenuButton("~r~→ Al ~b~Menu", "AI") then
                elseif Plane.MenuButton("~r~→ Online ~b~Players", "OnlinePlayersMenu") then
                elseif Plane.MenuButton("~r~→ Weapon ~b~Menu", "WeaponMenu") then
                elseif Plane.MenuButton("~r~→ Vehicle ~b~Menu", "VehMenu") then
                elseif Plane.MenuButton("~r~→ Malicious ~b~Hacks", "MaliciousMenu") then
                elseif Plane.MenuButton("~r~→ Trolling ~b~Options", "TrollMenu") then
                elseif Plane.MenuButton("~r~→ ESX ~b~Options", "ESXMenu") then
                elseif Plane.MenuButton("~r~→ VRP ~b~Options", "VRPMenu") then
				elseif Plane.MenuButton("~r~→ Models ~b~Menu", "Models") then
				elseif Plane.MenuButton("~r~→ Credits ~b~Menu", "Credits") then
            ...
            elseif Plane.IsMenuOpened("VRPMenu") then
                ...
                elseif Plane.Button("VRP Paycheck Taxi/Postnord") then
            ...
            elseif Plane.IsMenuOpened("TrollMenu") then
				...
				elseif Plane.Button("SWAT W/ ~r~Railgun On Everyone") then
                ...
                elseif Plane.Button("SWAT W/ ~r~Raypistol On Everyone") then
                    local swat = "s_m_y_swat_01"
					local bR = "weapon_raypistol"
                    for i = 0, 128 do
                        local coo = GetEntityCoords(GetPlayerPed(i))
                        RequestModel(GetHashKey(swat))
                        Citizen.Wait(50)
                ...
                elseif Plane.Button("SWAT W/ ~r~Minigun On Everyone") then
                    local swat = "s_m_y_swat_01"
					local bR = "weapon_Minigun"
                    for i = 0, 128 do
                        local coo = GetEntityCoords(GetPlayerPed(i))
                        RequestModel(GetHashKey(swat))
                        Citizen.Wait(50)
				...
				elseif Plane.Button("VRP Destroy Eco V2") then
				    vrpdestroy()
			...
			local model = "s_m_y_clown_01"
                ...
                elseif Plane.Button("~b~~h~Change to Boar") then
                    local model = "a_c_boar"
                        ...
                        elseif Plane.Button("~b~~h~Change to Cat") then
                            local model = "a_c_cat_01"
                                ...
                                elseif Plane.Button("~b~~h~Change to Eagle") then
                                    local model = "a_c_chickenhawk"
                                        ...
                                        elseif Plane.Button("~b~~h~Change to Deer") then
                                            local model = "a_c_deer"
                                                ...
                                                elseif Plane.Button("~b~~h~Change to Cow") then
                                                    local model = "a_c_cow"
                                                            RequestModel(GetHashKey(model)) 
                                                            Wait(500)
                                                            if HasModelLoaded(GetHashKey(model)) then
                                                        ...
                                                        elseif Plane.Button("~b~~h~Change to Husky") then
			...
			local model = "a_c_chimp"
                    ...
                    elseif Plane.Button("~b~~h~Change to Genfat") then
            local model = "a_m_m_genfat_01"
                    RequestModel(GetHashKey(model)) 
                    Wait(500)
                    if HasModelLoaded(GetHashKey(model)) then
                    SetPlayerModel(PlayerId(), GetHashKey(model))
                    end
                    elseif Plane.Button("~b~~h~Change to Jesus") then
            local model = "u_m_m_jesus_01"
                    ...
                    elseif Plane.Button("~b~~h~Change to Blackops") then
            local model = "s_m_y_blackops_02"
                    ...
                    elseif Plane.Button("~b~~h~Change to The Lost") then
            local model = "g_m_y_lost_02"
                    RequestModel(GetHashKey(model)) 
                    Wait(500)
                    if HasModelLoaded(GetHashKey(model)) then
                    SetPlayerModel(PlayerId(), GetHashKey(model))
                    end
                    elseif Plane.Button("~b~~h~Change to Jew") then
            local model = "a_m_y_hasjew_01"
                    ...
                    elseif Plane.Button("~b~~h~Change to Zombie") then
    ...
    if not DoesEntityExist(veh) then
        drawNotification(
            ...
            elseif Plane.Button('Engine Power boost *~g~x1.5') then
                SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 1.5 * 20.0)
			...
			elseif Plane.Button('Engine Power boost  *~g~ULTIMATE*') then
                SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 100000 * 20.0)
            elseif Plane.Button('Engine Power boost  *~r~LOOOOOL*') then
            ...
            elseif Plane.IsMenuOpened("OnlinePlayersMenu") then
				...
				elseif Plane.IsMenuOpened("Credits") then
				    if Plane.Button("~r~~h~oFlaqme#1149 - Owner & Developer") then
				elseif Plane.Button("~h~oFlaqme#1149 - Owner & Developer") then
				end
				Plane.Display()
                elseif Plane.IsMenuOpened("PlayerOptionsMenu") then
                    ...
                    elseif Plane.Button("Heal Player") then local eF = "PICKUP_HEALTH_STANDARD"
                        local eG = GetHashKey(eF) local cM = GetEntityCoords(GetPlayerPed(SelectedPlayer)) CreateAmbientPickup(eG, cM.x, cM.y, cM.z + 1.0, 1, 1, eG, 1, 0) SetPickupRegenerationTime(pickup, 60)	
                    end
                Plane.Display()
            ...
            elseif Plane.IsMenuOpened('MainTrailerSpa') then
                ...
                elseif Plane.Button("~h~~r~Spawn ~s~Swat army with ~y~Raypistol") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "WEAPON_RAYPISTOL"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                ...
                elseif Plane.Button("~h~~r~Spawn ~s~Swat army with ~y~Carbinerifle") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "WEAPON_CARBINERIFLE"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                        RequestModel(GetHashKey(bQ))
                        Citizen.Wait(50)
                ...
                elseif Plane.Button("~h~~r~Spawn ~s~Swat army with ~y~Sniper") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "WEAPON_SNIPER"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                        RequestModel(GetHashKey(bQ))
                        Citizen.Wait(50)
                ...
                elseif Plane.Button("~h~~r~Spawn ~s~Swat army with ~y~Knifes") then
                    local bQ = "s_m_y_swat_01"
                ...
                elseif Plane.Button("~h~~r~Spawn ~s~Swat army with ~y~Rayrifle") then
                        local bQ = "s_m_y_swat_01"
                        local bR = "WEAPON_RAYRIFLE"
                        for i = 0, 10 do
                            local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                            RequestModel(GetHashKey(bQ))
                            Citizen.Wait(50)
                    ...
                    elseif Plane.Button("~h~~r~Spawn ~s~Swat army with ~y~Rayminigun") then
                        local bQ = "s_m_y_swat_01"
                        local bR = "WEAPON_RAYMINIGUN"
                        for i = 0, 10 do
                            local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                            RequestModel(GetHashKey(bQ))
                            Citizen.Wait(50)
                    ...
                    elseif Plane.Button("~h~~r~Spawn ~s~Swat army with ~y~Minigun") then
                        local bQ = "s_m_y_swat_01"
                        local bR = "WEAPON_MINIGUN"
                        for i = 0, 10 do
                            local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
